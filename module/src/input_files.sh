...
echo "e6a5a8ec__USER_____________Toronto____________________4__450.0___true___3" > availablerentalsfile.txt #> to rewrite the file
echo "113142f7__USER_____________Whitby_____________________2__300.0___false__0" >> availablerentalsfile.txt #>> instead of > to append
echo "2cd2dfcb__USER_____________Oshawa_____________________5__499.99__true___3" >> availablerentalsfile.txt
echo "ae3e68e7__USR______________Stratford-Upon-Avon________3__249.99__false__0" >> availablerentalsfile.txt
echo "91510b4f__USR______________London_____________________9__999.99__true___2" >> availablerentalsfile.txt
