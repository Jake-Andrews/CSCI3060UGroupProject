...
for file in $parent_path/inputs/*; do 
    echo "running test ${file##*/}" 
    java -jar $parent_path/../../../../target/bnb-1.0-SNAPSHOT-jar-with-dependencies.jar availablerentalsfile.txt useraccounts.txt < $file > $parent_path/outputs/${file##*/} #${file##*/} contains the filename
done